...
ActiveRecord::Schema.define(version: 2022_06_11_112507) do
  ...
  create_table "pafs_core_contributor_details", id: :serial, force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_pafs_core_contributor_details_on_name"
  end
  ...
  create_table "pafs_core_projects", id: :serial, force: :cascade do |t|
    ...
    t.float "hectares_of_interdial_habitat_created_or_enhanced"
    t.boolean "woodland"
    ...
    t.float "hectares_of_wetland_or_wet_grassland_habitat_created_or_enhance"
    t.boolean "grassland"
