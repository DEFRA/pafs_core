...
module PafsCore
  class HectaresOfHeathlandCreatedOrEnhancedStep < BasicStep
    ...
    def step_params(params)
      params
        .require(:hectares_of_heathland_created_or_enhanced_step)
        .permit(:hectares_of_heathland_created_or_enhanced)
    end
    ...
    def amount_is_present_and_correct
      ...
      elsif hectares_of_heathland_created_or_enhanced <= 0
        errors.add(:hectares_of_heathland_created_or_enhanced,
                   "^You must include the number of hectares "\
                   "your project will create.")
      end
